...
interface InfiniteGalleryProps {
	...
	onImageHeld?: (imageSrc: string) => void;
}
...
function GalleryScene({
	...
	onImageHeld,
}: Omit<InfiniteGalleryProps, 'className' | 'style'> & { onImageHeld?: (imageSrc: string) => void }) {
			...
			{planesData.current.map((plane, i) => {
				...
				return (
					<ImagePlane
						...
						material={material}
						onHold={() => {
							if (onImageHeld && normalizedImages[plane.imageIndex]) {
								onImageHeld(normalizedImages[plane.imageIndex].src);
							}
						}}
					/>
				);
